...
export default function DeepDiveIntoFundamentalAIRisks() {
  return (
    <PageWrapper filename={__filename}>
      ...
      <p>Bostrom illustrates with this experiment the thesis about the orthogonality of the essence of intelligence and its ultimate goals. He categorizes the outcomes of the described actions as a type of what he calls <em>infrastructural profusion</em>. &quot;<em>Profusion</em> &quot; here means unjustified overproduction of paperclips from the point of view of human logic. Bostrom explains this effect by Superintelligence&apos;s desire to maximize the reward for achieving a certain result if the limit to its indicators was not explicitly set.</p>
      ...
      <p>AI may submit to human decisions if such a directive is an essential part of it. The result may be an internal conflict between its logic and the need to follow the directive. That can lead to unpredictable changes in its cognitive mechanism, up to it making inadequate decisions similar to those of people in a state of insanity (a similar incident was vividly described in A. Clarke&apos;s novel <em>2001: A Space Odyssey</em>).</p>
      ...
      <p>That is what, in essence, we need Superintelligence for.</p>
      <p>It means that we need to do everything to control its evolution.</p>
      <p>But how to achieve this?</p>
      <p>It is not only a huge technical but also a moral problem. We have only hints at solving the first and strong suspicions that the second will become increasingly complex.</p>
      ...
      <p>Although this situation can be called natural for the field of high technology, in the case of AI, it presents several extremely serious challenges to the developer community. The ability to respond to it will depend on much more than career, market, and even national prospects. The stake is truly the fate of humanity.</p>
      ...
      <p>That is only a small part of the list of problems that AI experts at all levels will have to comprehend and solve. The prospects for these solutions depend on many factors, including the coordination and integration of various approaches to fulfill the task of creating safe AI and coordinating the involved technical specialists with the scientific community, regulators, and policymakers.</p>
